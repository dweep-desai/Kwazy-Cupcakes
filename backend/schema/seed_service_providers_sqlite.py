...
def seed_service_providers():
    ...
    try:
        ...
        mkisan_data = [
            ('PROCUREMENT_AGENT', 'LIC123456', 'GST01ABCD1234A1Z5', 10),
            ('WHOLESALER', 'LIC234567', 'GST02EFGH5678B2Y6', 15),
            ('PROCUREMENT_AGENT', 'LIC345678', 'GST03IJKL9012C3X7', 8),
            ('EXPORTER', 'LIC456789', 'GST04MNOP3456D4W8', 20),
            ('WHOLESALER', 'LIC567890', 'GST05QRST7890E5V9', 12),
            ('RETAILER', 'LIC678901', 'GST06UVWX2345F6U0', 5),
            ('PROCUREMENT_AGENT', 'LIC789012', 'GST07YZAB6789G7T1', 9),
            ('PROCESSING_UNIT', 'LIC890123', 'GST08CDEF0123H8S2', 18),
            ('WHOLESALER', 'LIC901234', 'GST09GHIJ4567I9R3', 14),
            ('PROCUREMENT_AGENT', 'LIC012345', 'GST10KLMN8901J0Q4', 11),
        ]
